...
namespace ServicelinkASAP.Android.ViewModels
{
    public class SliderMenu:FrameLayout
    {
        bool opened;
        int contentOffsetX;
        ...
        const int ConfigMediumAnimTime = 5;
        ...
        public SliderMenu(Context context, IAttributeSet attrs) :
            base(context, attrs)
        {
            Initialize();
        }

        public SliderMenu(Context context, IAttributeSet attrs, int defStyle) :
        ...
        View ContentView
        {
            get
            {
                return FindViewById(Resource.Layout.MenuContentLayout);
            }
        }
        ...
        View MenuView
        {
            get
            {
                return FindViewById(Resource.Layout.MenuLayout);
            }
        }
        ...
        public void SetOpened(bool opened, bool animated = true)
        {
            ...
            else
            {
                ...
                animator.SetDuration(Context.Resources.GetInteger(ConfigMediumAnimTime));
