...
public class ExpendableListViewAdapter
		...
		mono.android.IGCUserPeer
{
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("ServicelinkASAP.Android.ExpendableListViewAdapter, ServicelinkASAP.Android, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", ExpendableListViewAdapter.class, __md_methods);
	}


	public ExpendableListViewAdapter () throws java.lang.Throwable
	{
		super ();
		if (getClass () == ExpendableListViewAdapter.class)
			mono.android.TypeManager.Activate ("ServicelinkASAP.Android.ExpendableListViewAdapter, ServicelinkASAP.Android, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
